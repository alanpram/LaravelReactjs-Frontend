            ...
            <Navbar bg="dark" variant="dark" expand="lg" fixed="top">
                ...
                <Navbar.Collapse id="navbarScroll" className='d-none'>
                    ...
                    <NavDropdown title="PRODUCTS" id="basic-nav-dropdown">
                        <NavDropdown.Item href="#action2">BEDROOM</NavDropdown.Item>
                        <NavDropdown.Item href="#action2">DECORATION</NavDropdown.Item>
                        <NavDropdown.Item href="#action2">CARPETS</NavDropdown.Item>
                    </NavDropdown>
